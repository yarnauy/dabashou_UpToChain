...
public class DisposeRewardItem extends DynamicStruct {
  ...
  public DisposeRewardItem(Utf8String timestamp, Utf8String orderID, Utf8String category,
  ...
  public DisposeRewardItem(String timestamp, String orderID, String category, BigInteger amount,
